...
contract stZETAMinterV205 is NativeMinterWithdrawalFlashLoan, NativeMinterInstantWithdrawal, StakingAdmin {
    ...
    function balanceAvailable() public view virtual override(BaseMinterWithdrawal, NativeMinterWithdrawal, NativeMinterWithdrawalFlashLoan) returns (uint256) {
        return NativeMinterWithdrawalFlashLoan.balanceAvailable();
    }
