...
interface IMinter {
    ...
    function requestWithdrawal(uint256 amount, address receiver) external returns (uint256 withdrawalId);
    function claimWithdrawal(uint256 withdrawalId, address receiver) external;
}
interface ILending {
